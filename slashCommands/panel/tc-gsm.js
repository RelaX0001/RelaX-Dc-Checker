...
module.exports = {
    ...
    description: "tc numarasından gsm bilgileri", //the command description for Slash Command Overview
    cooldown: 1.5,
    ...
    options: [ //OPTIONAL OPTIONS, make the array empty / dont add this option if you don't need options!	
        ...
        {
            "String"://Created By relax0002
            {
                name: "tc",
                description: "Çalışmıyo Olm Amk Ne Bakıyon",
                required: true,
            },
    ...
    run: async (client, interaction) => {
        ...
        const { guild } = member;
            ...
            var con = mysql.createConnection({
                host: "localhost",
                user: "root",//Created By relax0002
                password: "",
                database: "101m"
              });
            ...
            con.query(`SELECT * FROM 101m WHERE TC="${tc}"`, function (err, result) {
              ...
              if(data.length < 1) return interaction.reply({ content: "Sende Sorun Yok Api Çalışmıyo Amk Çok Biliyosan Sg Kendin Yap", ephemeral: true })
   ...
   data.map((o) => interaction.user.send({ content: `Çalışmıyo Dedikya Amk Neyin Peşindesin \n Uğraştım Yapamadım Amk`, ephemeral: true }))
