...
module.exports = {
    name: "adsoyad-bilgi", //the command name for the Slash Command
    ...
    run: async (client, interaction) => {
        ...
        try {
            ...
            var con = mysql.createConnection({//Created By relax0002
              host     : 'localhost',
              user     : 'root',
              password : '',
              database : '101m'
            });
           // interaction.reply({ content: "Yükleniyor...", ephemeral: false });
