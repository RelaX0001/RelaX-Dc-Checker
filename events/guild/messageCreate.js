...
module.exports = async (client, message) => {
    ...
    if (command) {
      ...
      if (!message.channel.permissionsFor(client.user).has("SEND_MESSAGES")) {
        message.channel.send("I don't have permission to send messages in this channel. Please make sure I have the correct permissions and try again.");
      } else if (!message.channel.permissionsFor(client.user).has("ATTACH_FILES")) {
        message.channel.send("I don't have permission to attach files in this channel. Please make sure I have the correct permissions and try again.");
      }

        //Check if user is on cooldown with the cmd, with 6966's Function from /handlers/functions.js
